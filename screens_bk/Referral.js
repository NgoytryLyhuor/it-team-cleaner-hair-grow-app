                        ...
                        <TouchableWithoutFeedback>
                            <Animated.View style={[styles.modalContainer, { transform: [{ translateY: slideAnim }] }]}>
                                ...
                                <View style={styles.modalContent}>
                                    ...
                                    <View style={styles.stepRow}>
                                        <Image
                                            source={require('../assets/icons/ic_percentage_square.png')}
                                            style={styles.stepIcon}
                                        />
                                        <CustomText style={styles.stepText}>
                                            Your friends book an appointment and apply your code to receive a discount.
                                        </CustomText>
                                    </View>
                                    <View style={styles.stepRow}>
                                    ...
                                    <View style={styles.noteContainer}>
                                        <CustomText style={styles.noteText}>
                                            Each referral code can only be used once per person.
                                        </CustomText>
                                    </View>
                                </View>
                            </Animated.View>
